...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        boolean autoLogin = mAutoLoginCheckBox.isChecked();
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new UserLoginTask(email, password,autoLogin, this);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserLoginTask(String email, String password, Boolean autoLogin, Context context) {
            mEmail = email;
            mPassword = password;
            mContext = context;
        ...
        protected Boolean doInBackground(Void... params) {
            String path = "http://192.168.191.1:8080/FindFriends/webresources/profile/findByEmail/"+mEmail;
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                Toast.makeText(mContext,getString(R.string.error_login_verify),Toast.LENGTH_SHORT).show();
